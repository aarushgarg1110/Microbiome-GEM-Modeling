...
% https://www.vmh.life such that microbiome community models created from the
...
%                            Designer on https://www.vmh.life (or manually).
...
elseif strcmp(setupUsed, 'Microbiota')
    ...
    for i = 1:size(adaptedDietConstraints, 1)
        ...
        origDietConstr=find(strcmp(VMHDietConstraints(:,1),adaptedDietConstraints{i, 1}));
