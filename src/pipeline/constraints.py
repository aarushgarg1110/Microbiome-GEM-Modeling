...
def prune_coupling_constraints_by_species(
    ...
    species present in the sample-specific model.
    ...
    Args:
        ...
        present_species (list[str]): List of species present in the sample.
        sample_model (cobra.Model): The sample-specific model after pruning species.
